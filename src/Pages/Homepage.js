				...
				<main className="home-main">
					<div className="container">
						<div className="header-logo">
							<img
								src="https://res.cloudinary.com/lawfirm1000/image/upload/v1721815412/paul-ajibs_foslnw.jpg"
								alt="header logo"
							/>
						</div>
						<div className="home">
                        ...
                        …building successful products, one product at a time.
                        </em>
						<div className="get-started">
							<Link to="/work" data-aos="fade" data-aos-delay="2500">
